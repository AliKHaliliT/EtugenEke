...
The server uses Python's [logging](https://docs.python.org/3/library/logging.html) module for logging. The logs are stored in the `logs` folder.
...
<div align="center">
  <img src="util_resources/readme/reset_password_func.gif" alt="passwordResetFunc.gif">
</div>
...
<div align="center">
  <img src="util_resources/readme/admin_panel.png" alt="adminPanel.png">
</div>
